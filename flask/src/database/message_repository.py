...
class MessageRepository:
    ...
    def create_message(self, sender: str, recipient: str, message: str):
        self.database_gateway.create_or_update_list(DATABASE_NAME, MESSAGE_COLLECTION_NAME, {MESSAGE_SENDER: sender, MESSAGE_RECIPIENT: recipient}, {MESSAGE_CONTENT: message})
